        ...
        <FooterStyled>
            <Box pt={4} maxWidth={1050} width='100%' mx="auto" mb={5}>
                <Flex justifyContent="space-around">
                    <Box>
                        <Box fontWeight="bold" mb={2}>Products</Box>
                        <Box py={1}>Chart</Box>
                    ...
                    <Box >
                        <Box fontWeight="bold" mb={2}>Company</Box>
                        <Box  py={1}>About</Box>
                    ...
                    <Box >
                        <Box fontWeight="bold" mb={2}>Community</Box>
                    ...
                    <Box >
                        <Box fontWeight="bold" mb={2}>For business</Box>
                        <Box py={1}>Wigets</Box>
                    ...
                    <Flex>
                        <Box>
                            <Flex bg="#f0f3fa" px={3} py={1} sx={{borderRadius: "3px"}}>
                                <Image className="desktop-svg" src="/desktop.svg" alt="me" width="28" height="40" />
                        ...
                        <Box bg="#f0f3fa" ml={3} sx={{borderRadius: "3px"}} pt={1} px={2}>
                            <Image className="desktop-svg" src="/apple.svg" alt="me" width="135" height="40" />

                        </Box>
                        <Box  bg="#f0f3fa" ml={3} sx={{borderRadius: "3px"}} pt={1} px={2}>
                        <Image className="desktop-svg" src="/playstore.svg" alt="me" width="135" height="40" />

                        </Box>
                    </Flex>
                    <Flex px={5}>
                        <Box bg="#f0f3fa" mx={2} pt={2} sx={{borderRadius: "3px"}} px={2}>
                            <svg className="social-svg" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg"><path d="M14 4a10 10 0 011.56 19.88v-6.99h2.33l.45-2.89h-2.78v-1.88c0-.79.39-1.56 1.63-1.56h1.26V8.1s-1.14-.2-2.24-.2c-2.28 0-3.77 1.4-3.77 3.9V14H9.9v2.9h2.54v6.98A10.01 10.01 0 0114 4z" fill="#1877F2"></path></svg>
                        </Box>
                        <Box bg="#f0f3fa" mx={2} pt={2} sx={{borderRadius: "3px"}} px={2}>
                            <svg className="social-svg" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg"><path d="M10.28 22.26c7.55 0 11.68-6.26 11.68-11.67v-.53c.8-.58 1.49-1.3 2.04-2.13-.74.33-1.53.54-2.36.65.85-.5 1.5-1.32 1.8-2.28-.78.48-1.66.81-2.6 1a4.1 4.1 0 00-7 3.74c-3.4-.17-6.43-1.8-8.46-4.29a4.1 4.1 0 001.28 5.48c-.68-.02-1.3-.2-1.86-.5v.05a4.11 4.11 0 003.29 4.02 4 4 0 01-1.85.08 4.1 4.1 0 003.83 2.85A8.23 8.23 0 014 20.43a11.67 11.67 0 006.28 1.83z" fill="#1DA1F2"></path></svg>
                        </Box>
                        <Box bg="#f0f3fa" mx={2} pt={2} sx={{borderRadius: "3px"}} px={2}>
                            <svg className="social-svg" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg"><path d="M6 4a2 2 0 00-2 2v16c0 1.1.9 2 2 2h16a2 2 0 002-2V6a2 2 0 00-2-2H6zm4.36 7.83v9.34h-3.1v-9.34h3.1zm.2-2.9c0 .9-.67 1.62-1.75 1.62H8.8c-1.04 0-1.7-.71-1.7-1.6 0-.92.68-1.62 1.74-1.62s1.71.7 1.73 1.6zm4.6 12.24h-3.09s.03-8.46 0-9.34h3.08v1.34a3.07 3.07 0 012.8-1.56c2.03 0 3.56 1.34 3.56 4.2v5.36h-3.1v-5c0-1.25-.44-2.1-1.56-2.1-.85 0-1.36.57-1.59 1.13-.08.2-.1.48-.1.76v5.21z" fill="#2867B2"></path></svg>
                        </Box>
                    </Flex>
                </Flex>


                <Flex justifyContent="space-between" mt={4} color="#787b86">
                    <Box>
                    ...
                    <Flex flexDirection="column" >
                        <Box>Select market data provided by <span className="company">ICE Data Services</span></Box>
