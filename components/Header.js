...
function Header(){
    ...
    return(
        <HeaderStyled>
            <Flex id="menu" className="sidebar" width={["70%","50%","30%","30%","30%"]} bg="white" flexDirection="column" py={1} height="100%" opacity={1}>
                <Box onClick={toggleMenu} pl={3} sx={{borderBottom: '1px solid #e0e3eb'}} py={3}>
                ...
                <Flex pl={3} pt={4}>
                    <Box>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28"><path fill="currentColor" d="M14.05 4.95a.62.62 0 00-.6 0L5.2 9.45a.62.62 0 00.3 1.18H22a.62.62 0 00.3-1.18l-8.25-4.5zm-.3 1.26l5.8 3.17H7.95l5.8-3.17zM8.5 12.75a.75.75 0 00-1.5 0V20h1.5v-7.25zm8 0a.75.75 0 00-1.5 0V20h1.5v-7.25zm3.25-.75c.41 0 .75.34.75.75V20H19v-7.25c0-.41.34-.75.75-.75zm-7.25.75a.75.75 0 00-1.5 0V20h1.5v-7.25zM5 22.25c0-.41.34-.75.75-.75h16a.75.75 0 010 1.5h-16a.75.75 0 01-.75-.75z"></path></svg>
                    </Box>
                    <Box pt={1} pl={3} sx={{borderBottom: '1px solid #e0e3eb'}} width="100%" pb={4}>
                    Markets
                    </Box>
                ...
                <Flex pl={3} pt={4}>
                    <Box>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28"><path fill="currentColor" fill-rule="evenodd" d="M6 5.5h13c.28 0 .5.22.5.5v14a.5.5 0 01-.5.5H6a.5.5 0 01-.5-.5V6c0-.28.22-.5.5-.5zM4 6c0-1.1.9-2 2-2h13a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm4 4.25a.75.75 0 000 1.5h9a.75.75 0 000-1.5H8zM7.25 14c0-.41.34-.75.75-.75h9a.75.75 0 010 1.5H8a.75.75 0 01-.75-.75zM8 16.25a.75.75 0 000 1.5h6a.75.75 0 000-1.5H8z"></path><path fill="currentColor" d="M8.06 23.5A2 2 0 0010 25h12a2 2 0 002-2V9a2 2 0 00-1.5-1.94V23a.5.5 0 01-.5.5H8.06z"></path></svg>
                    </Box>
                    <Box pt={1} pl={3} sx={{borderBottom: '1px solid #e0e3eb'}} width="100%" pb={4}>
                    Community
                    </Box>
                ...
                <Flex pl={3} pt={4}>
                    <Box bg="#e0e3eb" sx={{borderRadius: '5px'}} height="25px" px={1} textAlign="center" fontSize='14px' pt={1}>
                    EN
                    </Box>
                    <Box pt={1} pl={3} sx={{borderBottom: '1px solid #e0e3eb'}} width="100%" pb={4}>
                    English
            ...
            <Box maxWidth={960} width='100%'  mt={[2,2,2,4,4]} mx={[2,2,2,"auto","auto"]}>
                ...
                <Flex justifyContent="space-between" mb={[3,3,3,0,0]} >
                    ...
                    <Flex>
                        <Box>
                            <svg className="profile" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M17.5 9c0 1.14-.3 1.99-.79 2.54-.46.52-1.27.96-2.71.96s-2.25-.44-2.71-.96A3.74 3.74 0 0 1 10.5 9c0-1.14.3-1.99.79-2.54.46-.52 1.27-.96 2.71-.96s2.25.44 2.71.96c.5.55.79 1.4.79 2.54zM19 9c0 2.76-1.45 5-5 5s-5-2.24-5-5 1.45-5 5-5 5 2.24 5 5zm-8 8.5h6c2.04 0 3.1.5 3.76 1.1.69.63 1.11 1.55 1.5 2.8.13.42.04.95-.29 1.4-.33.46-.8.7-1.22.7H7.25c-.43 0-.89-.24-1.22-.7a1.61 1.61 0 0 1-.3-1.4 6.08 6.08 0 0 1 1.51-2.8c.65-.6 1.72-1.1 3.76-1.1zm6-1.5h-6c-4.6 0-5.88 2.33-6.7 4.96-.58 1.89.97 4.04 2.95 4.04h13.5c1.98 0 3.53-2.15 2.95-4.04C22.88 18.33 21.6 16 17 16z" fill="currentColor"></path></svg>
                        </Box>
                        <Box display={["none","none","none","block","block"]}  ml={3} bg="#2962ff" pt='5px' px={2} color="white" sx={{borderRadius: '4px',cursor: 'pointer'}}>
                            Start free trial
                        </Box>
                    </Flex>
                </Flex>
                ...
                <Box mt={3} justifyContent="left" display={["none","none","none","flex","flex"]}>
                    <Flex mr={3} className="nav-item">
                        <Box>
                            <svg className="chart-icon" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M9 6.5h10A2.5 2.5 0 0121.5 9v10a2.5 2.5 0 01-2.5 2.5H9A2.5 2.5 0 016.5 19V9A2.5 2.5 0 019 6.5zM5 9a4 4 0 014-4h10a4 4 0 014 4v10a4 4 0 01-4 4H9a4 4 0 01-4-4V9zm14.52 3.54a.75.75 0 10-1.04-1.08l-2.88 2.8-2.82-2.11a.75.75 0 00-.97.06l-3.33 3.25a.75.75 0 001.04 1.08l2.88-2.8 2.82 2.11c.3.22.7.2.97-.06l3.33-3.25z" fill="currentColor"></path></svg>
                        </Box>
                        <Box pt={1} >Chart</Box>
                    </Flex>
                    <Box mx={3} pt={1} className="nav-item">Trade</Box>
                    <Box mx={3} pt={1} className="nav-item">Markets</Box>
                    <Box mx={3} pt={1} className="nav-item">Screener</Box>
                    <Box mx={3} pt={1} className="nav-item">Community</Box>
                    <Box mx={3} pt={1} className="nav-item">More</Box>
                </Box>
